const predefinedQueries = [
  ...
  },
  {
    ...
    data: [
      ...
      { categoryID: 9, productCount: 12, avgPrice: 34.23 },
      { categoryID: 10, productCount: 12, avgPrice: 22.58 },
      { categoryID: 11, productCount: 13, avgPrice: 26.47 },
      { categoryID: 12, productCount: 10, avgPrice: 28.51 },
      { categoryID: 13, productCount: 7, avgPrice: 21.35 },
      { categoryID: 14, productCount: 6, avgPrice: 54.33 },
      { categoryID: 15, productCount: 7, avgPrice: 32.59 },
      { categoryID: 16, productCount: 10, avgPrice: 25.49 },
      { categoryID: 17, productCount: 12, avgPrice: 34.23 },
      { categoryID: 18, productCount: 12, avgPrice: 22.58 },
      { categoryID: 19, productCount: 13, avgPrice: 26.47 },
      { categoryID: 20, productCount: 10, avgPrice: 28.51 },
      { categoryID: 21, productCount: 7, avgPrice: 21.35 },
      { categoryID: 22, productCount: 6, avgPrice: 54.33 },
      { categoryID: 23, productCount: 7, avgPrice: 32.59 },
      { categoryID: 24, productCount: 10, avgPrice: 25.49 },
      { categoryID: 25, productCount: 12, avgPrice: 34.23 },
      { categoryID: 26, productCount: 12, avgPrice: 22.58 },
      { categoryID: 27, productCount: 13, avgPrice: 26.47 },
      { categoryID: 28, productCount: 10, avgPrice: 28.51 },
      { categoryID: 29, productCount: 7, avgPrice: 21.35 },
      { categoryID: 30, productCount: 6, avgPrice: 54.33 },
      { categoryID: 31, productCount: 7, avgPrice: 32.59 },
      { categoryID: 32, productCount: 10, avgPrice: 25.49 },
    ],
  },
  {
    id: 3,
